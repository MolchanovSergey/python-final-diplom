...
from shops.forms import UserRegistrationForm, LoginForm
from shops.models import User, Product, ProductInfo, Category, Shop, Order, OrderItem, Parameter, ProductParameter
